...
with open('../convert_ids/name2annot_covid_interactors_from_gene_names.pkl','rb') as f:
...
with open("../convert_ids/name2uniprotURL_covid_interactors_from_gene_names.pkl",'rb') as f:
