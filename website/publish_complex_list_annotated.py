...
def get_complex_annot_score(comp):
...
def write_comp2prot(complex2prot,comp2names,suffix='',write_html_file = "./Complexes/Complex2proteins", folder_prefix='',cov_link="Complex2proteins_covid.html",logfile='logs.txt'):
...
th{
  border: 1px solid black;
    ...
    for key,val in complex2prot.items():
        ...
        complex2prot[key]['char_score'],complex2prot[key]['cand_score'], complex2prot[key]['min_annot'], complex2prot[key]['median_annot']=get_complex_annot_score(val)
...
write_comp2prot(complex2prot,comp_num2name,suffix='',write_html_file = "./Complexes/Complex2proteins_annotated", folder_prefix='',cov_link="Complex2proteins_annotated_covid.html",logfile='logs.txt')
write_comp2prot(covid_comp2prot,comp_num2name,suffix='_covid',write_html_file = "./Complexes/Complex2proteins_annotated", folder_prefix='',cov_link="Complex2proteins_annotated_covid.html",logfile='logs.txt')