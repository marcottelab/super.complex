...
from generate_protein_wise_complexes import get_uniprot_urls


def write_prot2comp(prot2complex,comp_num2name,write_path,suffix='',write_html_file = "./Complexes/Protein2complex", folder_pref='Predicted/',cov_link="Protein2complex_covid.html",logfile='logs.txt',prot2url_file="../convert_ids/name2uniprotURL_full_humap_from_gene_names.pkl",name2annot=''):
...
def main():
    ...
    write_prot2comp(prot2complex,comp_num2name,write_path = results_folder + '/res_pred_prot2comp' +  ".out",suffix='',write_html_file = "./Complexes/Protein2complex_annotated", folder_pref='Predicted/',cov_link="Protein2complex_annotated_covid.html",logfile=results_folder+'/res_metrics_more.out',prot2url_file=args.prot2url_file,name2annot=name2annot)
    write_prot2comp(covid_prot2complex,comp_num2name, write_path = results_folder + '/res_pred_prot2comp' + '_covid' + ".out",suffix='_covid',write_html_file = "./Complexes/Protein2complex_annotated", folder_pref='Predicted/',cov_link="Protein2complex_annotated_covid.html",logfile=results_folder+'/res_metrics_more.out',prot2url_file = args.prot2url_file,name2annot=name2annot)
