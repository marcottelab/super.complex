...
def write_prot2comp(prot2complex,comp_num2name,write_path,suffix='',write_html_file = "./Complexes/Protein2complex", folder_pref='Predicted/'):
...
write_prot2comp(prot2complex,comp_num2name,write_path = results_folder + '/res_pred_prot2comp' +  ".out")
write_prot2comp(covid_prot2complex,comp_num2name, write_path = results_folder + '/res_pred_prot2comp' + '_covid' + ".out",suffix='_covid')